...
echo '${goto 600}''${font mono:Bold:size=10}'$TOPLINE | sed 's/Su/${color red}Su${color}/g' | sed 's/Sa/${color red}Sa${color}/g'
echo '${goto 600}''${font mono:bold:size=10}''${color C28C3A}'$OVER '${color 5BED1B}'$TODAY'${color}'$REST
